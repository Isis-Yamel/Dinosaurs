 ...
 * SSL: git@github.com:Isis-Yamel/Dinosaurs.git

2. Once you have it in your local. Go to the folder that contains the project and run ```npm install```

3. When the install finished, run ```npm run```. Automatically the project will open in browser tab.
### Big Picture
...
- [:white_check_mark:] The form should contain a button which upon clicking, removes the form
- [:white_check_mark:] The button should append a grid with 9 tiles to the DOM with the Human located in the center
- [:white_check_mark:] The Human tile should display the name of the person and an image, the dino tiles should contain the species, an image and a fact, the bird title should contain the species, image, and "All birds are Dinosaurs."


To complete this project, your backend code must:

- [:white_check_mark:] Contain a class and all necessary objects
- [:white_check_mark:] Contain at least 3 methods for comparing dinosaurs to the human
- [:white_check_mark:] Get user data from the DOM
- [:white_check_mark:] Append tiles with object data to DOM
